            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group form-group-feedback form-group-feedback-right">
                        ...
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') ? old('name') : $user->name  }}" required autocomplete="name" autofocus placeholder="Nombre">
